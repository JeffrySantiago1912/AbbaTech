          ...
          >
            <div className="relative animate-float">
              ...
              <motion.div
                ...
                className="absolute -bottom-5 -right-5 bg-[#25d366] text-white px-4 py-2.5 rounded-2xl flex items-center gap-2 shadow-[0_8px_32px_rgba(37,211,102,0.45)]"
              >
              ...
              <motion.div
                ...
                className="absolute -top-5 -left-5 glass px-4 py-2.5 rounded-2xl"
              >
